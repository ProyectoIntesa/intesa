...
public class P_PantallaJefeFabrica extends Composite {
	...
	public P_PantallaJefeFabrica(String usuarioLogueado, String rolUsuario) {
		
		Window.setTitle("INTESA - JEFE DE FÁBRICA");
