...
public class RemitoProvisionInsumo  extends PopupPanel{
	...
	public RemitoProvisionInsumo(OrdenProvisionInsumoDTO orden){
		...
		tablaElementos.getCellFormatter().setWidth(0, COL_INSUMO, "25%");
		tablaElementos.setText(0, COL_MARCA, constante.marca());
		tablaElementos.getCellFormatter().setWidth(0, COL_MARCA, "25%");
		tablaElementos.setText(0, COL_CANT, constante.cantidad());
		tablaElementos.getCellFormatter().setWidth(0, COL_CANT, "10%");
		tablaElementos.setText(0, COL_CANTFAL, constante.cantFaltante());
		tablaElementos.getCellFormatter().setWidth(0, COL_CANTFAL, "10%");
		tablaElementos.getRowFormatter().addStyleName(0, "tablaEncabezado");
		tablaElementos.setText(0, COL_CANTENT, constante.cantEntregada());
		tablaElementos.getCellFormatter().setWidth(0, COL_CANTENT, "15%");
		tablaElementos.getRowFormatter().addStyleName(0, "tablaEncabezado");
		...
		for (RenglonOrdenProvisionInsumoDTO renglon : orden.getRenglonOrdenProvisionInsumos()) {
			...
			tablaElementos.setWidget(item, COL_CANTFAL, new Label());
			tablaElementos.setWidget(item, COL_CANTENT, cantEntregadaTb);
